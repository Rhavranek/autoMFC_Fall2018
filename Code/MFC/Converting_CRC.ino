...
// this is my function I'll call. I will put my cmnd in as a byte array
...
void loop (){
  ...
  String cmnd = "!Setr10.00"; // bring in a the stringe command "Sinv2.000"
